{
  const templates = {
    ...
    authorSidebarList: Handlebars.compile(document.querySelector('#template-authorsidebar-list').innerHTML),
  }
  ...
  const generateAuthors = function(){
    ...
    authorList.innerHTML = templates.authorSidebarList(allAuthorsData);
